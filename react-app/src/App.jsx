      ...
      <div class="row">
        ...
        <div>
          ...
          <div class="check-group">
            ...
            <label class="check-label"><input id="staffAutoAssign" type="checkbox" checked /> 자동 배정 대상</label>
          </div>
        </div>
        <div>
...
const legacyScript = `const rooms = [
    ...
    function saveStaff() {
      ...
      const staffAutoAssign = document.getElementById("staffAutoAssign").checked;
      ...
      if (editingStaffId) {
        ...
        if (target) {
          ...
          target.staffAutoAssign = staffAutoAssign;
        ...
        staff.push({ id: uid(), name, worksWeekday, worksSaturday, staffAutoAssign, workStart, workEnd, breakStart, breakEnd });
    ...
    function editStaff(id) {
      ...
      document.getElementById("staffAutoAssign").checked = target.staffAutoAssign !== false;
    ...
    function cancelEdit() {
      ...
      document.getElementById("staffAutoAssign").checked = true;
      ...
      staff.forEach(s => {
        ...
        div.innerHTML = \`
          <div>
            ...
            <span>자동 배정: \${s.staffAutoAssign !== false ? "포함" : "제외"}</span>
    ...
    function autoFillWeekdaySameParityFromManual(slot, fixedRoomId, fixedStaffId) {
      ...
      const chosen = chooseStaffForRooms({
        ...
        targetRooms,
        block: [slot],
        baseFilter: person => person.staffAutoAssign !== false && canWork(mode, person, slot) && isStaffFreeInSlot(mode, person.id, slot),
        initiallyUsed: used
      });
    ...
    function assignWeekdayBlock(startTime, shift, parity, label) {
      ...
      const chosen = chooseStaffForRooms({
        ...
        block,
        baseFilter: person => {
          return person.staffAutoAssign !== false &&
    ...
    async function loadDefaultStaffFromCloud(show = true) {
      ...
      try {
        ...
        staff = (snap.data().staffList || []).map(s => ({
          ...
          staffAutoAssign: s.staffAutoAssign !== false,
