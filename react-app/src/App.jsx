    ...
    <div class="modal-card modal-card-lg">
      ...
      <div class="modal-body default-staff-modal-body">
        <div class="default-staff-form-section">
          ...
          <p class="help">&#53664;&#50836;&#51068; &#44540;&#47924; &#45813;&#45813;&#51088; &#51204;&#52404;&#50640; &#44277;&#53685; &#51201;&#50857;&#46104;&#45716; &#55092;&#44172; &#49884;&#44036;&#51077;&#45768;&#45796;. &#54704;&#45813;&#45813;&#51088; &#49444;&#51221; &#53664;&#44400;&#51012; &#53080;&#47533;&#50640; &#54568;&#44084; &#51200;&#51109;&#46429;&#45768;&#45796;.</p>
        </div>
        <div class="default-staff-form-section">
...
const legacyScript = `const rooms = [
      ...
      staff.forEach(s => {
        ...
        div.innerHTML = \`
          <div>
            ...
            <span>토요일 근무자는 10:00~19:00 전체 근무 / \${CONFIG.saturday.commonBreakStart}~\${CONFIG.saturday.commonBreakEnd} 공통 휴게</span>
          </div>
      ...
      if (activeMode === "weekday") {
        ...
        box.innerHTML = \`
          <div class="rule">
            ...
            토요일은 10:00~19:00 기준이며, \${CONFIG.saturday.commonBreakStart}~\${CONFIG.saturday.commonBreakEnd}은 공통 휴게 시간입니다. 토요일 근무자로 체크된 담당자만 자동/수동 배정 후보가 됩니다.
          </div>
          <div class="rule">
    ...
    function applyData(rawData) {
      ...
      if (rawData.saturdayCommonBreakStart) CONFIG.saturday.commonBreakStart = rawData.saturdayCommonBreakStart;
      if (rawData.saturdayCommonBreakEnd) CONFIG.saturday.commonBreakEnd = rawData.saturdayCommonBreakEnd;
  ...
  measurementId: "\${nextConfig.measurementId || ""}"
    ...
    async function loadDefaultStaffFromCloud(show = true) {
      ...
      try {
        ...
        if (loadedData.saturdayCommonBreakStart) CONFIG.saturday.commonBreakStart = loadedData.saturdayCommonBreakStart;
        if (loadedData.saturdayCommonBreakEnd) CONFIG.saturday.commonBreakEnd = loadedData.saturdayCommonBreakEnd;
        cleanInvalidAssignments();
        renderStaff();
        renderTable();
        saveData(false);
    ...
    function modalResetForm() {
      ...
      if (satBreakStartEl) satBreakStartEl.value = CONFIG.saturday.commonBreakStart || "13:00";
      if (satBreakEndEl) satBreakEndEl.value = CONFIG.saturday.commonBreakEnd || "14:00";
    ...
    function saveSaturdayBreakSetting() {
      ...
      saveData(false);
      saveToCloud(false);
      showModalNotice("토요일 공통 휴게 시간이 적용되었습니다.", "info");
    }
