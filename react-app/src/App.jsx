  ...
  <div class="app-layout">
    <aside class="calendar-sidebar">
      ...
      <div class="sidebar-actions">
        <button class="secondary" onclick="openAutoAssignOverrideModal()">&#51088;&#46041; &#48176;&#51221; &#45824;&#49345; &#49444;&#51221;</button>
      ...
      <div class="row">
        ...
        <div>
          ...
          <div class="check-group">
            ...
            <label class="check-label"><input id="staffAutoAssignDefault" type="checkbox" checked /> 기본 자동 배정 대상</label>
          </div>
        </div>
        <div>
...
const legacyScript = `const rooms = [
    ...
    function saveStaff() {
      ...
      const staffAutoAssignDefault = document.getElementById("staffAutoAssignDefault").checked;
      ...
      if (editingStaffId) {
        ...
        staff.push({ id: uid(), name, worksWeekday, worksSaturday, staffAutoAssignDefault, workStart, workEnd, breakStart, breakEnd });
    ...
    function editStaff(id) {
      ...
      document.getElementById("staffAutoAssignDefault").checked = target.staffAutoAssignDefault !== false;
    ...
    function cancelEdit() {
      ...
      document.getElementById("staffAutoAssignDefault").checked = true;
      ...
      staff.forEach(s => {
        ...
        div.innerHTML = \`
          <div>
            ...
            <span>기본 자동 배정: \${s.staffAutoAssignDefault !== false ? "포함" : "제외"}</span>
